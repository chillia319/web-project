<?php
$scriptList = array('jquery-3.1.0.min.js', 'cookies.js', 'showHide.js', 'cart.js', 'review.js');
...
<div id="main">
    ...
    <section class="film">
        ...
        <?php
            addReviewForm("Attack_of_the_50ft_Woman");
        ?>
    </section>
    ...
    <section class="film">
        ...
        <?php
            addReviewForm("The_Day_of_the_Triffids");
        ?>
    </section>
    ...
    <section class="film">
        ...
        <?php
            addReviewForm("Forbidden_Planet");
        ?>
    </section>
    ...
    <section class="film">
        ...
        <?php
            addReviewForm("Plan_9_from_Outer_Space");
        ?>
    </section>
